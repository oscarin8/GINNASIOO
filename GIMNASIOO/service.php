            ...
            <table>
                <tr>
                    ...
                    foreach ($servicios as $servicio) {
                        echo "<td>";
                        echo '<img class="img-fluid" src="img/' . $servicio['foto'] . '" alt="' . $servicio['nombre'] . '" style="width: 300px;"><br>';
...
<div class="row mx-0 justify-content-center text-center">
    <div class="col-lg-8 d-flex align-items-center justify-content-center">
        <div class="horizontal-table">
            ...
            $servicios = Servicio::mostrarServicios();
            ?>
            <table id="dataTable" class="display" style="border-collapse: collapse; border: 0.5px solid #ddd;">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Nombre</th>
                ...
                <tbody>
                    ...
                    foreach ($servicios as $servicio) {
                        ...
                        echo '<td><img src="img/' . $servicio['foto'] . '" alt="' . $servicio['nombre'] . '" style="width: 50px;"></td>';
...
<div class="row mx-0 justify-content-center text-center mt-3">
    <div class="col-lg-8 d-flex justify-content-between">
        <button id="btnAgregar">Añadir</button>
        
    </div>
</div>
<div id="formulario" class="row mx-0 justify-content-center text-center mt-3" style="display: none;"tabindex="-1" >
    <div class="col-lg-8">
        <form id="formAgregar" enctype="multipart/form-data"class="modal-body">
